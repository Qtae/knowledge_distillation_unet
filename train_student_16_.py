...
if __name__ == '__main__':
    ...
    teacher_model_path = root_dir + 'model_teacher/model(2022_07_14-13_44_00)_teacher_F'
    ...
    train_images, train_labels, valid_images, valid_labels = load_dataset(data_dir)
