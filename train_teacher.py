...
if __name__ == '__main__':
    ...
    ##callbacks
    #checkpoint
    check_point_save_dir = 'D:/Work/01_Knowledge_Distillation/model_teacher/checkpoints/' + start_time
    ...
    checkpoint = tf.keras.callbacks.ModelCheckpoint(os.path.join(check_point_save_dir, check_point_filename),
                                                    ...
                                                    mode='max')
    #early stoping
    early_stopping = tf.keras.callbacks.EarlyStopping(monitor='val_accuracy', patience=15, mode='auto')
    #reduce learning rate on plateau
    reduce = tf.keras.callbacks.ReduceLROnPlateau(monitor='val_accuracy', factor=0.9, patience=5, cooldown=10,
